...
// Defining inteface
interface ContentInteface
{
  public function display();
  public function edit();
}

// Implementing the interace in Article Class
class Article implements ContentInteface
{
  private $title;
  private $content;
...
// Implementing the interface in Video Class
class Video implements ContentInteface
{
  private $title;
  private $url;
