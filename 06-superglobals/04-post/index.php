    ...
    <div class="bg-white p-8 rounded shadow-md w-full max-w-md">
      ...
      <form method="post" action="">
        ...
        <div class="mb-6">
          ...
          <textarea id="description" name="description" placeholder="Enter job description" class="w-full px-4 py-2 border rounded focus:ring focus:ring-blue-300 focus:outline-none">
